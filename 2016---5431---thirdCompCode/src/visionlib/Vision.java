...
public class Vision {
	...
	public static double[] getRPMS(double[] currentRPM, double currentPWR) {
		//SmarterDashboard.putNumber("DISTANCE", getDistance());
	...
	public static boolean withIn(double num, double lower, double upper) {
